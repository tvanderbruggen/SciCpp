...
.. function:: TxtLoader<DataTypes...> delimiter(char delimiter)

Set the character used to separate values. Default is a whitespace :code:`' '`.

--------------------------------------

.. function:: TxtLoader<DataTypes...> skiprows(int skiprows)

Number of rows to be skip at top of the file. Default value is :code:`0`.

--------------------------------------

.. function:: TxtLoader<DataTypes...> comments(char comments)

Character used to indicate the start of a commented row. Default is :code:`'#'`.

--------------------------------------

.. function:: TxtLoader<DataTypes...> usecols(const std::vector<int> &usecols)

.. function:: TxtLoader<DataTypes...> usecols(std::vector<int> &&usecols)

.. function:: template <typename... Columns> TxtLoader<DataTypes...> usecols(Columns... usecols)
...
.. function:: TxtLoader<DataTypes...> converters(ConvertersDict converters)
...
.. function:: TxtLoader<DataTypes...> max_rows(int max_rows)

Set the maximum number of lines to be read. By default all lines are read.

--------------------------------------

.. function:: TxtLoader<DataTypes...> filters(FiltersDict filters)
