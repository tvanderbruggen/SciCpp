...
TEST_CASE("Print nan") {
    ...
    REQUIRE(array2string(v) == "[  1.           2.                  nan]\n");

    PrintOptions prtopts{};
    prtopts.nanstr = "NaN";
    REQUIRE(array2string(v, prtopts) ==
            "[  1.           2.                  NaN]\n");
}
...
TEST_CASE("Print inf") {
    ...
    REQUIRE(array2string(v) == "[  1.           2.                  inf]\n");
...
TEST_CASE("Print complex inf, -inf") {
    ...
    REQUIRE(array2string(v) ==
            "[         inf+1.00000000j   2.00000000+3.00000000j  "
            " 3.00000000-infj]\n");
...
TEST_CASE("Print a short array of reals") {
    const auto v = signal::windows::hann<double, 16>();
    REQUIRE(
        array2string(v) ==
...
TEST_CASE("Print a short array of complex") {
    ...
    REQUIRE(array2string(window_cplx) ==
...
TEST_CASE("Print a short array of units") {
    ...
    REQUIRE(array2string(std::array{1._m, 2._m, 3._m, 4._m}) ==
            "[  1.           2.           3.           4.        ]\n");
}
